...
def main(
    ...
    trainer = pl.Trainer(limit_train_batches=2, max_epochs=2, gpus = 2, plugins=DDPPlugin(find_unused_parameters=False))
...
""" 
Used DDP + num_workers = 2 for 2 epochs -> 4 fetching processes.
...
0 tensor([1, 1, 4, 4, 2, 2, 3, 3, 0, 0])
0 tensor([0, 0, 4, 4, 2, 2, 3, 3, 1, 1])
0 tensor([2, 2, 1, 1, 0, 0, 4, 4, 3, 3])
0 tensor([1, 1, 4, 4, 3, 3, 0, 0, 2, 2])
0 tensor([3, 3, 2, 2, 4, 4, 1, 1, 0, 0])
0 tensor([4, 4, 2, 2, 1, 1, 0, 0, 3, 3])
0 tensor([0, 0, 3, 3, 4, 4, 1, 1, 2, 2])
0 tensor([1, 1, 4, 4, 0, 0, 3, 3, 2, 2])
0 tensor([2, 2, 3, 3, 4, 4, 1, 1, 0, 0])
...
1 tensor([3, 3, 1, 1, 2, 2, 4, 4, 0, 0])
1 tensor([2, 2, 0, 0, 1, 1, 3, 3, 4, 4])
1 tensor([1, 1, 4, 4, 2, 2, 3, 3, 0, 0])
1 tensor([0, 0, 4, 4, 2, 2, 3, 3, 1, 1])
1 tensor([2, 2, 1, 1, 0, 0, 4, 4, 3, 3])
1 tensor([1, 1, 4, 4, 3, 3, 0, 0, 2, 2])
1 tensor([3, 3, 2, 2, 4, 4, 1, 1, 0, 0])
1 tensor([4, 4, 2, 2, 1, 1, 0, 0, 3, 3])

2 tensor([2, 2, 4, 4, 1, 1, 0, 0, 3, 3])
2 tensor([1, 1, 4, 4, 2, 2, 0, 0, 3, 3])
2 tensor([1, 1, 2, 2, 4, 4, 0, 0, 3, 3])
2 tensor([4, 4, 3, 3, 2, 2, 1, 1, 0, 0])
2 tensor([3, 3, 1, 1, 2, 2, 4, 4, 0, 0])
2 tensor([2, 2, 0, 0, 1, 1, 3, 3, 4, 4])
2 tensor([1, 1, 4, 4, 2, 2, 3, 3, 0, 0])
2 tensor([0, 0, 4, 4, 2, 2, 3, 3, 1, 1])
2 tensor([2, 2, 1, 1, 0, 0, 4, 4, 3, 3])
2 tensor([1, 1, 4, 4, 3, 3, 0, 0, 2, 2])
2 tensor([3, 3, 2, 2, 4, 4, 1, 1, 0, 0])
2 tensor([4, 4, 2, 2, 1, 1, 0, 0, 3, 3])
2 tensor([2, 2, 0, 0, 3, 3, 1, 1, 4, 4])
2 tensor([0, 0, 3, 3, 4, 4, 1, 1, 2, 2])
2 tensor([1, 1, 4, 4, 0, 0, 3, 3, 2, 2])
2 tensor([2, 2, 3, 3, 4, 4, 1, 1, 0, 0])

3 tensor([2, 2, 4, 4, 1, 1, 0, 0, 3, 3])
3 tensor([1, 1, 4, 4, 2, 2, 0, 0, 3, 3])
3 tensor([1, 1, 2, 2, 4, 4, 0, 0, 3, 3])
3 tensor([4, 4, 3, 3, 2, 2, 1, 1, 0, 0])
3 tensor([3, 3, 1, 1, 2, 2, 4, 4, 0, 0])
3 tensor([2, 2, 0, 0, 1, 1, 3, 3, 4, 4])
3 tensor([1, 1, 4, 4, 2, 2, 3, 3, 0, 0])
3 tensor([0, 0, 4, 4, 2, 2, 3, 3, 1, 1])
3 tensor([2, 2, 1, 1, 0, 0, 4, 4, 3, 3])
3 tensor([1, 1, 4, 4, 3, 3, 0, 0, 2, 2])
3 tensor([3, 3, 2, 2, 4, 4, 1, 1, 0, 0])
3 tensor([4, 4, 2, 2, 1, 1, 0, 0, 3, 3])
...
0 tensor([1, 1, 3, 3, 2, 2, 4, 4, 0, 0])
0 tensor([1, 1, 4, 4, 0, 0, 2, 2, 3, 3])
0 tensor([0, 0, 1, 1, 3, 3, 2, 2, 4, 4])
0 tensor([3, 3, 4, 4, 1, 1, 2, 2, 0, 0])
0 tensor([2, 2, 3, 3, 0, 0, 4, 4, 1, 1])
0 tensor([1, 1, 2, 2, 0, 0, 4, 4, 3, 3])
0 tensor([1, 1, 2, 2, 4, 4, 3, 3, 0, 0])
0 tensor([1, 1, 0, 0, 2, 2, 4, 4, 3, 3])
...
1 tensor([0, 0, 1, 1, 3, 3, 2, 2, 4, 4])
1 tensor([3, 3, 4, 4, 1, 1, 2, 2, 0, 0])
1 tensor([2, 2, 3, 3, 0, 0, 4, 4, 1, 1])
1 tensor([1, 1, 2, 2, 0, 0, 4, 4, 3, 3])
1 tensor([1, 1, 2, 2, 4, 4, 3, 3, 0, 0])
1 tensor([1, 1, 0, 0, 2, 2, 4, 4, 3, 3])
1 tensor([0, 0, 1, 1, 3, 3, 4, 4, 2, 2])
1 tensor([4, 4, 2, 2, 0, 0, 3, 3, 1, 1])
1 tensor([4, 4, 3, 3, 1, 1, 0, 0, 2, 2])
1 tensor([4, 4, 1, 1, 2, 2, 3, 3, 0, 0])

2 tensor([0, 0, 4, 4, 1, 1, 3, 3, 2, 2])
2 tensor([0, 0, 1, 1, 3, 3, 4, 4, 2, 2])
2 tensor([2, 2, 1, 1, 4, 4, 0, 0, 3, 3])
2 tensor([4, 4, 1, 1, 2, 2, 3, 3, 0, 0])
2 tensor([1, 1, 3, 3, 2, 2, 4, 4, 0, 0])
2 tensor([1, 1, 4, 4, 0, 0, 2, 2, 3, 3])
2 tensor([0, 0, 1, 1, 3, 3, 2, 2, 4, 4])
2 tensor([3, 3, 4, 4, 1, 1, 2, 2, 0, 0])
2 tensor([2, 2, 3, 3, 0, 0, 4, 4, 1, 1])
2 tensor([1, 1, 2, 2, 0, 0, 4, 4, 3, 3])
2 tensor([1, 1, 2, 2, 4, 4, 3, 3, 0, 0])
2 tensor([1, 1, 0, 0, 2, 2, 4, 4, 3, 3])

3 tensor([0, 0, 4, 4, 1, 1, 3, 3, 2, 2])
3 tensor([0, 0, 1, 1, 3, 3, 4, 4, 2, 2])
3 tensor([2, 2, 1, 1, 4, 4, 0, 0, 3, 3])
3 tensor([4, 4, 1, 1, 2, 2, 3, 3, 0, 0])
3 tensor([1, 1, 3, 3, 2, 2, 4, 4, 0, 0])
3 tensor([1, 1, 4, 4, 0, 0, 2, 2, 3, 3])
3 tensor([0, 0, 1, 1, 3, 3, 2, 2, 4, 4])
3 tensor([3, 3, 4, 4, 1, 1, 2, 2, 0, 0])
3 tensor([2, 2, 3, 3, 0, 0, 4, 4, 1, 1])
3 tensor([1, 1, 2, 2, 0, 0, 4, 4, 3, 3])
3 tensor([1, 1, 2, 2, 4, 4, 3, 3, 0, 0])
3 tensor([1, 1, 0, 0, 2, 2, 4, 4, 3, 3])
3 tensor([4, 4, 2, 2, 0, 0, 3, 3, 1, 1])
3 tensor([4, 4, 3, 3, 1, 1, 0, 0, 2, 2])
3 tensor([4, 4, 1, 1, 2, 2, 3, 3, 0, 0])
"""